...
from get_attributes import get_attributes  # Importing the get_attributes function from the new file
...
""")
    ...
    print("Generated Prompts:", final_prompts)  # Debug logging

    # Call the get_attributes function to get attributes for each prompt
    prompts_with_attributes = get_attributes(model_path, final_prompts)

    return prompts_with_attributes
